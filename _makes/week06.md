---
layout: default
title: "Week 6 – Reverse Engineering"
---

<div class="card-section">
<h1>Week 6 – Reverse Engineering</h1>
</div>

<div class="card-section">
<h2>The Artifact</h2>
<div style="text-align:center; margin: 0 auto 2rem; max-width: 720px;">
  <img src="{{ '/assets/images/week06-artifact.png' | relative_url }}" alt="Week 6 artifact" style="width:100%;height:auto;box-shadow:0 12px 30px rgba(0,0,0,0.08);border-radius:16px;" />
</div>
